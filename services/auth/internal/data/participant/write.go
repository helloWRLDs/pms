...
func (r *Repository) Create(ctx context.Context, participant entity.Participant) (err error) {
	log := r.log.With(
...
func (r *Repository) Update(ctx context.Context, participantID string, updated entity.Participant) (err error) {
	log := r.log.With(
